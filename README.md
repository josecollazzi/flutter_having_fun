...
- all features are using freezed (autogenerated code) and 
- todo build a long list with items with images that take long to load (only computing when is needed)
